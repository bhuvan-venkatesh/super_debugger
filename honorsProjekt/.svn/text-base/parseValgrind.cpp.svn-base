...
/**
 *	Prints the memory summary report from valgrind
 *
 */
void printMem() {
...
/**
 *	Prints the tuple object passed in
 *
 * 	@param t: The tuple holding the function name, file, and line number we want to print
 */
...
/**
 *	Prints the error object passed in
 *
 * 	@param t: The errors object we want to print 
 */
...
/**
 *	Prints all the errors by category
 *
 */
void printCategory() {
	cerr << "\n";
...
/**
 *	Split the string passed in by delimiter (got online)
 *
 * 	@param str: Arguments passed straight from original main function
 * 	@param delim: What we want to split the string by
 * 	@param numtokens: The length of the array we return (pass this in by reference)
 * 	@return The parsed string as an array of strings
 */
...
/**
 *	Split the string passed in by delimiter (an alternative method to above)
 *
 * 	@param str: The entire valgrind file piped to a string
 */
...
/**
 *	Prints out all the errors that can be handled right away
 *
 */
void handleNows() {
  cerr << "\n----------------------------------------------------------------------------------"
